...
<html lang="pt-br">
    ...
    <body>
        <div class="topo">
            <div>
                <img src="assents/logo-icone.png" alt="logo do grupo">
                <h2>SK2R</h2>
                <p>Gestão em Segurança da Informação</p>
            </div>
                ...
                <form action="contato.php" method="post">
                    <fieldset>
                        ...
                        <div class="inputBox">
                            ...
                            <label for="nome" class="labelinput">Nome do Resposável</label>
                            <br><br>
                        </div>
                            <label for="data_nascimento"><b>Data de Nascimento do Responsável:</b></label>
                        ...
                        <br>
                        <input type="radio" id="grande" name="porte" value="grande" required>
                        <label for="grande">Grande</label>
                        <br>
                        <input type="radio" id="medio" name="porte" value="medio" required>
                        <label for="medio">Médio</label>
                        <br>
                        <input type="radio" id="pequeno" name="porte" value="pequeno" required>
        ...
        <div class="rodape">
            ...
            <p>Régis Morais do Nascimento RA 202302382673</p>
            <p>Rodrigo Bonturi da Rocha Filho RA 202302381073</p>
            <p>Kadmiel Morais Vera RA 202302382517</p>
            <p>Todos os direitos reservados para a SK2R - Gestão da Segurança da Informação</p>
        </div>
    </body>
